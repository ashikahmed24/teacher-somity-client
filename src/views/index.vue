                    ...
                    <div class="flex flex-wrap items-start gap-4">
                        <div class="flex-none w-60 h-auto">
                            <div class="block">
                                ...
                                <h4 class="font-semibold py-2">মো বদরুল আমিন সরকার
                                </h4>
                            </div>
                        </div>
                        <div class="grow">
                        ...
                        <div class="bg-white shadow-lg rounded-2xl overflow-hidden">
                            ...
                            <div class="bg-gradient-to-r from-blue-600 to-indigo-600 p-6">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <h1 class="text-white text-2xl font-semibold">বাংলাদেশ বেসরকারী শিক্ষক সমিতি
                                        </h1>
                                        <p class="text-blue-100 mt-1 text-sm">অফিস আদেশ / সাধারণ নোটিশ</p>
                                    </div>
                            ...
                            <div class="p-6">
                                <!-- Notice display -->
                                <div class="mb-4">
                                    <label class="block text-slate-600 font-medium mb-2">নোটিশ (দেখুন / সম্পাদনা
                                        করুন)</label>
                                    <textarea
...
বাংলাদেশ বেসরকারী শিক্ষক সমিতি</textarea>
                                ...
                                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                                    <div class="text-sm text-slate-500">
                                        <span class="font-medium">প্রস্তুত:</span> নোটিশ কপি/প্রিন্ট বা ইমেইলে পাঠানোর
                                        জন্য ব্যবহার করুন
                                    </div>

                                    <div class="flex gap-2">
                                        <button class="base__outline" type="button">
                                            Preview
                                        </button>

                                        <button class="base__button" type="button">
                                            Send
                                        </button>
                                    </div>
                                </div>
